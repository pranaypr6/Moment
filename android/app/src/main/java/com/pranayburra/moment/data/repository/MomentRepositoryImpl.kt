...
import com.pranayburra.moment.data.remote.CreateMomentRequest
...
class MomentRepositoryImpl @Inject constructor(
    ...
    override suspend fun toggleFavorite(momentId: String): Resource<Unit> {
        return try {
            ...
            val request = com.pranayburra.moment.data.remote.FavoriteRequest(isFavorite = updatedMoment.isFavorite)
    ...
    override suspend fun getUploadUrl(contentType: String, contentLength: Long): Result<com.pranayburra.moment.data.remote.UploadUrlResponse> {
        return try {
