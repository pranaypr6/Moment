package com.pranayburra.moment.widget
...
import com.pranayburra.moment.worker.SendPresenceWorker
import com.pranayburra.moment.di.WidgetEntryPoint
...
class RelationshipWidget : GlanceAppWidget() {
    ...
    private fun WidgetContent(myBitmap: Bitmap?, partnerBitmap: Bitmap?, myVibe: String?, partnerVibe: String?, pairedAt: String?, subtitle: String) {
        ...
        Box(
            modifier = GlanceModifier
                .fillMaxSize()
                .background(ImageProvider(com.pranayburra.moment.R.drawable.widget_background))
            ...
            Column(
                ...
                Row(
                    ...
                    EmojiButton(com.pranayburra.moment.R.drawable.ic_thought_bubble, "ThinkingOfYou", lastAction, sendStatus)
                    Spacer(modifier = GlanceModifier.width(12.dp))
                    EmojiButton(com.pranayburra.moment.R.drawable.ic_punch_forward, "Punch", lastAction, sendStatus)
                    Spacer(modifier = GlanceModifier.width(12.dp))
                    EmojiButton(com.pranayburra.moment.R.drawable.ic_cuddling_teddies, "Cuddle", lastAction, sendStatus)
                    Spacer(modifier = GlanceModifier.width(12.dp))
                    EmojiButton(com.pranayburra.moment.R.drawable.ic_kiss_face, "Kiss", lastAction, sendStatus)
                    Spacer(modifier = GlanceModifier.width(12.dp))
                    EmojiButton(com.pranayburra.moment.R.drawable.ic_pleading_face, "MissYou", lastAction, sendStatus)
                }
            }
        }
    }
    ...
    private fun EditorialProfileImage(bitmap: Bitmap?, vibe: String?) {
        Box(
            ...
            Box(
                modifier = GlanceModifier
                    .size(52.dp)
                    .background(ImageProvider(com.pranayburra.moment.R.drawable.widget_profile_shadow))
            ) {
                if (bitmap != null) {
                    Image(
